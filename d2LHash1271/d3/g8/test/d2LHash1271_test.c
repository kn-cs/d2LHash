...
int main(int argc, char **argv) {
	...
	uchar8 k[KEY_SIZE] = {
		0xb0,0x40,0xe4,0xd2,0xad,0x16,0x7f,0x3a,		
	...
	fprintf(FILE,"CPU-cycles per byte for computing d2LHash271 using maax type computation on a message of length %llu bits: %6.4lf\n\n", l,((get_median())/(double)(n*N)));
